...
{
    static NSString *CellIdentifier = @"CalculatorProgramDescription";
...
- (BOOL)tableView:(UITableView *)tableView canEditRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [self.delegate respondsToSelector:@selector(favoritesTableViewController:deletedProgram:)];
}
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        id program = [self.programs objectAtIndex:indexPath.row];
        [self.delegate favoritesTableViewController:self deletedProgram:program];
    }
